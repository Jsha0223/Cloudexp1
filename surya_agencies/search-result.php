...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div style="color:white; background-color: green;" class="head"><i class="icon fa fa-align-justify fa-fw"></i>Sub Categories</div>        
    <nav class="yamm megamenu-horizontal" role="navigation">
  
        <ul class="nav">
            <li style="background-color:lightgreen ; color:white" class="dropdown menu-item">
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 style="color:green" class="section-title">A2agro Welcomes you!</h3>
