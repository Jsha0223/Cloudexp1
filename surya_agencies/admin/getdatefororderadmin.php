...
session_start();
	...
	//echo "<html>
echo "<head><title>Order details</title>";
?>
...
</head><body style="background-image:url('abstract.png');">
...
echo "<td valign='top' align='center'>";
	echo "<br/><br/><h2 align=center><font face='TAHOMA' color='red'>ORDERDATE</font></h2>";
...
<select name="productName">
					<?php
							$sql="SELECT productName FROM products group by productName";
