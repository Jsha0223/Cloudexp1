...
<br/><br/>
<h1 style="color:Black;font-weight:bold;text-align:center;">Order List</h1>
...
$op ="Order Date,User Name,Product Name,Qty,Price,Total\n";
...
if(  $row["Approved"] =='Approved')
{
  ...
  $op =$op . $row['orderdate'] . "," .  $row['username'] . "," .  $row['productname'] . "," .  $row['quantity'] . "," .  $row['productprice'] . "," .  $row["quantity"]*$row["productprice"] ."\n" ;
 ?>
  </td>
...
?>
<tr><td colspan='10'>
 <h1><a href="orders.csv">Export</a></h1></td></tr>
</tbody>
</table> </div>
</div>
