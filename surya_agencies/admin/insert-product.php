...
$sql=mysql_query("insert into products(category,subCategory,productName,productPrice,productDescription,shippingCharge,productAvailability,availablestock,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productprice','$productdescription','$productscharge','$productavailability','$availablestock','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<?php include('include/sidebar.php');?>				
			<div class="span9">
					<div class="content">
						...
						<div class="module">
							<div style="background-color:green" class="module-head">
...
<div class="control-group">
<label class="control-label" for="basicinput">Available Stock</label>
<div class="controls">
<input type="text"    name="availablestock"  placeholder="Enter Available Stock" class="span8 tip" >
</div>
</div>
...
<input type="file" name="productimage3"  class="span8 tip">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit"  style="background-color: green; color: #fff;">Add</button>
											</div>
										</div>
									</form>
							</div>
