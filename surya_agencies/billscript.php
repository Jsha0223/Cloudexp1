...
<body>
  ...
  <div class="col-75">
    <div class="container">
      ...
      <h2>Surya Agencies</h2>
        <div class="row">
          <div class="col-50">
            <center><h3>Package Bill</h3></center>
			<br>
            <label for="bfrom"><i class="fa fa-user"></i> Bill From: Surya Agencies</label>
            ...
            <label for="ino"><i class="fa fa-address-card-o"></i> Invoice No:</label>
