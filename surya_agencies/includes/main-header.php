...
<div class="logo">
	<a href="index.php">
		...
		<h2><img src="img/logo.png" width="130" height="60"></h2>
  ...
  height: 90px;
    ...
    <form name="search" method="post" action="search-result.php" id="rcorners2">
        <div class="control-group">
            ...
            <button style="width: 30px;height: 30px;" class="search-button" type="submit" name="search"></button>   
