...
<h3 style="color:#404a40"> ORDER HISTORY </h3>
		<table class="table table-bordered">
			<thead>
				<tr style="color:#404a40">
					...
					<th class="cart-total last-item">Invoice</th>
				</tr>
			</thead><!-- /thead -->
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
                    ...
                    <td>
                    	<a href="billscript.php?id=<?php echo $row['orderid']?>" target="_blank">
    <button style="color:black;background-color: green;color: white;"> Invoice</button>
  </a>
