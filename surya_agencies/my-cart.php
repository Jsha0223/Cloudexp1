				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a style="background-color: #404a40;" href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
								<input style="background-color: #404a40;" type="submit" name="submit" value="Update shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span style="color:green" class="estimate-title">Shipping Address</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span style="color:green;" class="estimate-title">Billing Address</span>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		<thead>
			<tr>
				<th>
					...
					<div style="color: green;" class="cart-grand-total">
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button style="background-color:green;" type="submit" name="ordersubmit" class="btn btn-primary">PROCCED TO CHEKOUT</button>
