...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Cake Categories</h3>
            ...
            <div class="item">
                ...
                <div class="item">
                    ...
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage3']);?>" height="300" />
                    </a>
                </div>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Suggestion <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button style="background-color:darkgreen;" name="submit" class="btn btn-primary btn-upper">SUBMIT REVIEW</button>
														</div><!-- /.action -->
...
while($rw=mysql_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productName']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="400" height="300" alt=""></a>
			</div><!-- /.image -->			
...
<?php include('includes/footer.php');?>
	...
	<script>
		...
		$(window).bind("load", function() {
		   $('.show-theme-options').delay(3000).trigger('click');
		});
	</script>
